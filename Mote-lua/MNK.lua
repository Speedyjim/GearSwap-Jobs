...
function user_setup()
	...
	send_command('bind delete input /ws Victory Smite <me>')
...
function init_gear_sets()
	...
	sets.precast.JA['Chakra'] = {ammo="Tantra Tathlum",
		head="Ejekamal Mask",ear1="Soil Earring",ear2="Soil Earring",
	...
	sets.precast.Waltz = {ammo="Tantra Tathlum",
		head="Uk'uxkaj Cap",
		body="Anch. Cyclas +1",hands="Hesychast's Gloves +1",ring1="Terrasoul Ring",ring2="Asklepian Ring",
	...
	sets.precast.WS = {ammo="Thew Bomblet",
		...
		body="Anchorite's Cyclas +1",hands="Anchorite's Gloves +1",ring1="Pyrosoul Ring",ring2="Epona's Ring",
		back="Atheling Mantle",waist="Windbuffet Belt",legs="Quiahuiz Trousers",
		feet={name="Qaaxo Leggings", augments={'Accuracy+15','STR+7','Phys. dmg. taken -3',}}}
	sets.precast.WSAcc = {ammo="Honed Tathlum",head="Whirlpool Mask",body="Manibozho Jerkin",hands="Hesychast's Gloves",back="Anchoret's Mantle",waist="Caudata Belt",legs="Manibohzo Brais"}
	...
	sets.precast.WS['Asuran Fists']    = set_combine(sets.precast.WS, {
		ear1="Bladeborn Earring",ear2="Moonshade Earring",ring2="Rajas Ring",back="Buquwik Cape"})
	sets.precast.WS["Ascetic's Fury"]  = set_combine(sets.precast.WS, {
		ammo="Tantra Tathlum",ring1="Spiral Ring",back="Buquwik Cape",feet="Qaaxo Leggings"})
	sets.precast.WS["Victory Smite"]   = set_combine(sets.precast.WS, {neck="Rancor Collar",back="Buquwik Cape",waist="Caudata Belt"})
	...
	sets.precast.WS['Cataclysm'] = {
		...
		body="Anchorite's Cyclas +1",hands="Achorite's Gloves +1",ring1="Acumen Ring",ring2="Rajas Ring",
	...
	sets.midcast.FastRecast = {
		...
		body="Anchorite's Cyclas +1",hands="Achorite's Gloves +1",
		waist="Black Belt",legs="Quiahuiz Leggings",feet="Otronif Boots +1"}
	...
	sets.idle.Town = {ammo="Potestas Bomblet",
		...
		body="Anchorite's Cyclas +1",hands="Hesychast's Gloves +1",ring1="Rajas Ring",ring2="Epona's Ring",
		back="Atheling Mantle",waist="Windbuffet Belt",legs="Hesychast's Hose +1",feet="Herald's Gaiters"}
	...
	sets.defense.PDT = {ammo="Iron Gobbet",
		...
		body="Anchorite's Cyclas +1",hands="Otronif Gloves +1",ring1="Patricius Ring",ring2=gear.DarkRing.physical,
		back="Repulse Mantle",waist="Black Belt",legs="Otronif Brais",feet="Otronif Boots"}

	sets.defense.HP = {}

	sets.defense.MDT = {ammo="Demonry Stone",
		head="Uk'uxkaj Cap",neck="Twilight Torque",ear1="Mujin Stud",ear2="Sanare Earring",
		body="Anchorite's Cyclas +1",hands="Hesychast's Gloves +1",ring1="Shadow Ring",ring2=gear.DarkRing.magical,
		back="Mubvum. Mantle",waist="Black Belt",legs="Nahtirah Trousers",feet="Daihanshi Habaki"}
	...
	sets.engaged.Acc = {ammo="Honed Tathlum",
		...
		body="Anchorite's Cyclas +1",hands="Hesychast's Gloves +1",ring1="Rajas Ring",ring2="Epona's Ring",
		back="Anchoret's Mantle",waist="Windbuffet Belt",legs="Manibozho Brais",
		feet={name="Qaaxo Leggings", augments={'Accuracy+15','STR+7','Phys. dmg. taken -3',}}}}
